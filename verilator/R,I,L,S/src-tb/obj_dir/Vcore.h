...
VL_MODULE(Vcore) {
  public:
    ...
    CData/*3:0*/ __Vtablechg1[256];
    CData/*2:0*/ __Vtablechg2[256];
    ...
    static CData/*1:0*/ __Vtable2_core__DOT__u_Core10__DOT__mem_to_reg[256];
    static CData/*3:0*/ __Vtable2_core__DOT__u_Core10__DOT__alu_control[256];
    static CData/*2:0*/ __Vtable2_core__DOT__u_Core10__DOT__u_Decode_stage0__DOT__imm_sel[256];
  ...
  public:
    ...
    static void _initial__TOP__3(Vcore__Syms* __restrict vlSymsp) VL_ATTR_COLD;
