...
VL_INLINE_OPT void Vcore::_sequent__TOP__1(Vcore__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->core__DOT__u_Core10__DOT__u_Decode_pipe0__DOT__r1 
        = (0x1fU & (vlTOPp->core__DOT__u_Core10__DOT__u_Fetch_pipe0__DOT__instruc 
                    >> 0xfU));
    vlTOPp->core__DOT__u_Core10__DOT__u_Decode_pipe0__DOT__r2 
        = (0x1fU & (vlTOPp->core__DOT__u_Core10__DOT__u_Fetch_pipe0__DOT__instruc 
                    >> 0x14U));
...
VL_INLINE_OPT void Vcore::_sequent__TOP__2(Vcore__Syms* __restrict vlSymsp) {
    ...
    if (vlTOPp->rst) {
        if (((IData)(vlTOPp->core__DOT__u_Core10__DOT__u_Decode_stage0__DOT__u_cu0__DOT__load) 
            ...
            if (vlTOPp->core__DOT__u_Core10__DOT__u_Decode_pipe0__DOT__nextsel) {
                vlTOPp->__Vdly__core__DOT__pc_address 
                    = vlTOPp->core__DOT__u_Core10__DOT__alu_res_out;
                vlTOPp->__Vdly__core__DOT__u_Core10__DOT__pre_pc 
                    = vlTOPp->core__DOT__pc_address;
            } else {
                if (vlTOPp->core__DOT__u_Core10__DOT__u_Decode_pipe0__DOT__branch_) {
                    if (vlTOPp->core__DOT__u_Core10__DOT__u_Decode_pipe0__DOT__branch_res) {
                        vlTOPp->__Vdly__core__DOT__pc_address 
                            = vlTOPp->core__DOT__u_Core10__DOT__alu_res_out;
                        vlTOPp->__Vdly__core__DOT__u_Core10__DOT__pre_pc 
                            = vlTOPp->core__DOT__pc_address;
                    ...
                    if (vlTOPp->core__DOT__u_Core10__DOT__u_Decode_pipe0__DOT__jalr) {
                        vlTOPp->__Vdly__core__DOT__pc_address 
                            = vlTOPp->core__DOT__u_Core10__DOT__alu_res_out;
                        vlTOPp->__Vdly__core__DOT__u_Core10__DOT__pre_pc 
                            = vlTOPp->core__DOT__pc_address;
    ...
    if (vlTOPp->rst) {
        if (vlTOPp->core__DOT__u_Core10__DOT__u_Execute_pipe0__DOT__reg_write) {
            vlTOPp->core__DOT__u_Core10__DOT__u_Decode_stage0__DOT__u_registerfile0__DOT____Vlvbound1 
                = ((0U == (IData)(vlTOPp->core__DOT__u_Core10__DOT__u_Execute_pipe0__DOT__mem_reg))
                    ...
                    : ((1U == (IData)(vlTOPp->core__DOT__u_Core10__DOT__u_Execute_pipe0__DOT__mem_reg))
                        ...
                        : ((2U == (IData)(vlTOPp->core__DOT__u_Core10__DOT__u_Execute_pipe0__DOT__mem_reg))
                            ...
                            : 0U)));
            if ((0x1eU >= (0x1fU & ((vlTOPp->core__DOT__u_Core10__DOT__u_Execute_pipe0__DOT__instruction 
                                     >> 7U) - (IData)(1U))))) {
...
VL_INLINE_OPT void Vcore::_sequent__TOP__5(Vcore__Syms* __restrict vlSymsp) {
    ...
    Vcore* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->core__DOT__u_Core10__DOT__u_Decode_pipe0__DOT__branch_res 
        = vlTOPp->core__DOT__u_Core10__DOT__branch_result;
    vlTOPp->core__DOT__u_Core10__DOT__u_Decode_pipe0__DOT__branch_ 
        = vlTOPp->core__DOT__u_Core10__DOT__u_Decode_stage0__DOT__u_cu0__DOT__branch;
    vlTOPp->core__DOT__u_Core10__DOT__u_Decode_pipe0__DOT__jalr 
        = vlTOPp->core__DOT__u_Core10__DOT__u_Decode_stage0__DOT__u_cu0__DOT__jalr;
    vlTOPp->core__DOT__u_Core10__DOT__u_Decode_pipe0__DOT__nextsel 
        = vlTOPp->core__DOT__u_Core10__DOT__u_Decode_stage0__DOT__u_cu0__DOT__jal;
    vlTOPp->core__DOT__u_Core10__DOT__u_Execute_pipe0__DOT__mem_reg 
        = vlTOPp->core__DOT__u_Core10__DOT__u_Decode_pipe0__DOT__mem_reg;
    vlTOPp->core__DOT__u_Core10__DOT__u_Execute_pipe0__DOT__alu_result 
        = vlTOPp->core__DOT__u_Core10__DOT__alu_res_out;
    vlTOPp->core__DOT__u_Core10__DOT__u_Execute_pipe0__DOT__nextsel_addr 
        = ((IData)(4U) + vlTOPp->core__DOT__u_Core10__DOT__u_Decode_pipe0__DOT__pre_address);
    vlTOPp->core__DOT__u_Core10__DOT__u_Execute_pipe0__DOT__instruction 
        = vlTOPp->core__DOT__u_Core10__DOT__u_Decode_pipe0__DOT__instruct;
    vlTOPp->core__DOT__u_Core10__DOT__u_Execute_pipe0__DOT__reg_write 
        = vlTOPp->core__DOT__u_Core10__DOT__u_Decode_pipe0__DOT__rg;
    vlTOPp->core__DOT__u_Core10__DOT__u_Decode_pipe0__DOT__mem_reg 
    ...
    if ((((IData)(vlTOPp->core__DOT__u_Core10__DOT__u_Decode_stage0__DOT__u_cu0__DOT__jal) 
        ...
        vlTOPp->__Vdly__core__DOT__u_Core10__DOT__u_Fetch_pipe0__DOT__flush_pipeline = 1U;
    } else {
        if (vlTOPp->core__DOT__u_Core10__DOT__u_Fetch_pipe0__DOT__flush_pipeline) {
            vlTOPp->core__DOT__u_Core10__DOT__u_Fetch_pipe0__DOT__pre_address = 0U;
            vlTOPp->core__DOT__u_Core10__DOT__u_Fetch_pipe0__DOT__instruc = 0U;
            vlTOPp->__Vdly__core__DOT__u_Core10__DOT__u_Fetch_pipe0__DOT__flush_pipeline = 0U;
            vlTOPp->__Vdly__core__DOT__u_Core10__DOT__u_Fetch_pipe0__DOT__flush_pipeline2 = 1U;
        } else {
            if (vlTOPp->core__DOT__u_Core10__DOT__u_Fetch_pipe0__DOT__flush_pipeline2) {
                vlTOPp->core__DOT__u_Core10__DOT__u_Fetch_pipe0__DOT__pre_address = 0U;
                vlTOPp->core__DOT__u_Core10__DOT__u_Fetch_pipe0__DOT__instruc = 0U;
                vlTOPp->__Vdly__core__DOT__u_Core10__DOT__u_Fetch_pipe0__DOT__flush_pipeline2 = 0U;
            } else {
